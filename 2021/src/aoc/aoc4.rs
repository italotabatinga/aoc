...
impl Aoc<String, u32> for Aoc4 {
    fn input() -> String {
        String::from(STR_INPUT)
    }

    fn part1_test_input() -> String {
        String::from(STR_TEST_INPUT)
    }

    fn part1(input: String, _: bool) -> u32 {
        let (chosen_numbers, mut boards) = parse_input(input);
    ...
    fn part2(input: String, _: bool) -> u32 {
        let (chosen_numbers, mut boards) = parse_input(input);
