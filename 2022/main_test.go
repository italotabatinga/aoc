...
func TestAoc131Test(t *testing.T) {
	runTest(Test{problem: Problem{Day: 13, Part: Part1, Test: true}, run: func(p Problem) int { return Run[aoc.Input13](p, aoc.Runner13{}) }, expected: 13}, t)
}

func TestAoc131(t *testing.T) {
	runTest(Test{problem: Problem{Day: 13, Part: Part1, Test: false}, run: func(p Problem) int { return Run[aoc.Input13](p, aoc.Runner13{}) }, expected: 5684}, t)
}

func TestAoc132Test(t *testing.T) {
	runTest(Test{problem: Problem{Day: 13, Part: Part2, Test: true}, run: func(p Problem) int { return Run[aoc.Input13](p, aoc.Runner13{}) }, expected: 140}, t)
}

func TestAoc132(t *testing.T) {
	runTest(Test{problem: Problem{Day: 13, Part: Part2, Test: false}, run: func(p Problem) int { return Run[aoc.Input13](p, aoc.Runner13{}) }, expected: 22932}, t)
}

func TestAoc141Test(t *testing.T) {
	runTest(Test{problem: Problem{Day: 14, Part: Part1, Test: true}, run: func(p Problem) int { return Run[aoc.Input14](p, aoc.Runner14{}) }, expected: 24}, t)
}

func TestAoc141(t *testing.T) {
	runTest(Test{problem: Problem{Day: 14, Part: Part1, Test: false}, run: func(p Problem) int { return Run[aoc.Input14](p, aoc.Runner14{}) }, expected: 638}, t)
}

func TestAoc142Test(t *testing.T) {
	runTest(Test{problem: Problem{Day: 14, Part: Part2, Test: true}, run: func(p Problem) int { return Run[aoc.Input14](p, aoc.Runner14{}) }, expected: 93}, t)
}

func TestAoc142(t *testing.T) {
	runTest(Test{problem: Problem{Day: 14, Part: Part2, Test: false}, run: func(p Problem) int { return Run[aoc.Input14](p, aoc.Runner14{}) }, expected: 31722}, t)
}

func TestAoc151Test(t *testing.T) {
	runTest(Test{problem: Problem{Day: 15, Part: Part1, Test: true}, run: func(p Problem) int { return Run[aoc.Input15](p, aoc.Runner15{}) }, expected: 26}, t)
}

func TestAoc151(t *testing.T) {
	runTest(Test{problem: Problem{Day: 15, Part: Part1, Test: false}, run: func(p Problem) int { return Run[aoc.Input15](p, aoc.Runner15{}) }, expected: 5108096}, t)
}

func TestAoc152Test(t *testing.T) {
	runTest(Test{problem: Problem{Day: 15, Part: Part2, Test: true}, run: func(p Problem) int { return Run[aoc.Input15](p, aoc.Runner15{}) }, expected: 93}, t)
}

// func TestAoc152(t *testing.T) {
// 	runTest(Test{problem: Problem{Day: 15, Part: Part2, Test: false}, run: func(p Problem) int { return Run[aoc.Input15](p, aoc.Runner15{}) }, expected: 31722}, t)
// }
